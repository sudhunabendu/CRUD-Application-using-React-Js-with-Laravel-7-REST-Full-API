...
class Student extends Component {
  ...
  getStudents() {
    axios.get("http://freshshopbackend.test/api/students").then((response) => {
  ...
  addStudent = () => {
    axios
      .post("http://freshshopbackend.test/api/create-student", this.state.newStudentData)
      .then((response) => {
  ...
  updateStudent = () => {
    ...
    axios
      .post("http://freshshopbackend.test/api/create-student", {
        first_name,
        last_name,
        email,
        phone,
  ...
  deletStudent = (id) => {
    ...
    axios.delete("http://freshshopbackend.test/api/student/" + id)
      .then((response) => {
        this.setState({
          isLoading: false,
        });
